...
<body>
  <header>
    ...
    <nav>
      <ul>
         <?php if($_SESSION['estado']=="desconectado"){echo "<li><a href=\"conectar.php\">Conectar</a></li>";}?>
         <?php if($_SESSION['estado']=="conectado"){echo "<li><a href=\"desconectar.php\">Desconectar</a></li>";}?>
      </ul>
    </nav>
  </header>
