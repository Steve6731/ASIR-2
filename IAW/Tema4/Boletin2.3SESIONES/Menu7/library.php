      ...
      <ul>
         <?php 
            if ($menu==MENU_PRINCIPAL){
               if($_SESSION['estado']=="conectado"){echo "<li><a href=\"secreto.php\">Secreto</a></li>";}
               if($_SESSION['estado']=="desconectado"){echo "<li><a href=\"conectar.php\">Conectar</a></li>";}
               if($_SESSION['estado']=="conectado"){echo "<li><a href=\"desconectar.php\">Desconectar</a></li>";}
            }
         ?>
         <?php if($menu==MENU_SECUNDARIO){echo "<li><a href=\"index.php\">Inicio</a></li>";}?>
      </ul>
    </nav>
  </header>
